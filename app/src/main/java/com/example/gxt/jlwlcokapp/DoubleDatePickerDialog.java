    ...
    private void tryNotifyDateSet() {
        if (mCallBack != null) {
            ...
            mCallBack.onDateSet(mDatePicker_start,
                    mDatePicker_start.getYear(),
                    mDatePicker_start.getMonth(),
                    mDatePicker_start.getDayOfMonth()
               /*     mDatePicker_start.getHour(),
                    mDatePicker_start.getMinute()*/
/*                    mDatePicker_end,
                    mDatePicker_end.getYear(),
                    mDatePicker_end.getMonth(),
...
/*        state.putInt(START_HOUR, mDatePicker_start.getHour());
        state.putInt(START_MINUTE, mDatePicker_start.getMinute());*/
...
/*        int start_hour = savedInstanceState.getInt(START_HOUR);
        int start_minute = savedInstanceState.getInt(START_MINUTE);*/
